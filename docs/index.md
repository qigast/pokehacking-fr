...
hero:
  name: "Site de référence pour le source-hacking des jeux Pokémon de la 3G."
  # text: "*LE* site de référence français pour le Rom-Hacking des jeux Pokémon de la 3G !"
  tagline: "2026, Qigast"
  actions:
    - theme: brand
